import { IconsVariant } from '../constants';
...
export const Icons = ({ variant = IconsVariant.OverallProgress }: IconsProps) => {
    const renderIcon = () => {
        switch (variant) {
            case IconsVariant.OverallProgress:
                return (
            ...
            case IconsVariant.TotalCriteria:
                return (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            case IconsVariant.CompletedCriteria:
                return (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            case IconsVariant.EvidenceDocuments:
                return (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            case IconsVariant.EvidenceCompleted:
                return (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            case IconsVariant.UploadedToDGA:
                return (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
